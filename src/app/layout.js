...
export async function generateMetadata() {
  ...
  return {
    ...
    icons: {
      icon: [
        { url: "/favicon.ico?v=avatar", type: "image/x-icon" },
        { url: "/favicon-16x16.png?v=avatar", sizes: "16x16", type: "image/png" },
        { url: "/favicon-32x32.png?v=avatar", sizes: "32x32", type: "image/png" },
        { url: "/img/favicon.png?v=avatar", sizes: "32x32", type: "image/png" },
      ],
      apple: [{ url: "/apple-touch-icon.png?v=avatar", sizes: "180x180" }],
    },
  };
}
