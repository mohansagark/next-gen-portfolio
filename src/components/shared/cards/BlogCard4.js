...
const BlogCard4 = ({ blog, idx }) => {
  const { id, img, title } = blog ? blog : {};
  // const category, date - unused variables from destructuring
  // const showAbleBlogTopList = blogTopList?.slice(1, 3); // Available for future use
